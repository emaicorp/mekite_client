        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col md:flex-row items-center mb-12">
            <div className="flex-shrink-0 mb-4 md:mb-0 md:w-1/4">
              <FaRegUser className="text-4xl text-green-500 mx-auto transition duration-300 ease-in-out transform hover:scale-110" />
            </div>
            <div className="md:w-3/4">
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Step 1: Register</h3>
          ...
          <div className="flex flex-col md:flex-row items-center mb-12">
            <div className="flex-shrink-0 mb-4 md:mb-0 md:w-1/4">
              <FaSearch className="text-4xl text-blue-500 mx-auto transition duration-300 ease-in-out transform hover:scale-110" />
            </div>
            <div className="md:w-3/4">
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Step 2: Search Offers</h3>
              <p className="text-lg text-gray-600">
          ...
          <div className="flex flex-col md:flex-row items-center mb-12">
            <div className="flex-shrink-0 mb-4 md:mb-0 md:w-1/4">
              <FaHandshake className="text-4xl text-orange-500 mx-auto transition duration-300 ease-in-out transform hover:scale-110" />
            </div>
            <div className="md:w-3/4">
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Step 3: Start a Trade</h3>
              <p className="text-lg text-gray-600">
          ...
          <div className="mt-12">
            <a
              href="/register"
              className="inline-block px-8 py-3 bg-yellow-500 text-white text-xl font-semibold rounded-lg hover:bg-yellow-400 transition duration-300 ease-in-out"
            >
