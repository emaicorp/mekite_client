...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    console.log('Stored User Details:', storedUserDetails); // Debugging line to check the contents
        ...
        <section className="mt-12 bg-gradient-to-r from-gray-800 to-gray-700 p-8 rounded-lg shadow-lg">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-6">
              ...
              <p className="text-xl"><b>Total Earnings:</b> {`$${userDetails.totalEarnings}`}</p>
            </div>
            <div className="flex items-center space-x-6">
              <FaBitcoin className="text-3xl text-yellow-500" />
              <p className="text-xl"><b>Bitcoin:</b> {userDetails.bitcoinAvailable}</p>
            </div>
            <div className="flex items-center space-x-6">
              <FaEthereum className="text-3xl text-indigo-500" />
              <p className="text-xl"><b>Ethereum:</b> {userDetails.ethereumAvailable}</p>
            </div>
            <div className="flex items-center space-x-6">
              <FaDollarSign className="text-3xl text-teal-400" />
              <p className="text-xl"><b>USDT:</b> {userDetails.usdtAvailable}</p>
            </div>
          </div>
        </section>
